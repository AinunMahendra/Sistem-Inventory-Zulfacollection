<x-layout bodyClass="g-sidenav-show bg-gray-200">
    <x-navbars.sidebar activePage="Dispatchings"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit Dispatching" beforePage="Dispatchings"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                <div class="col-md-8 d-flex align-items-center">
                                    <h6 class="mb-3">Edit Daftar Barang Keluar</h6>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-3">
                            <form method='POST' action='{{ route('update.dispatching', ['id' => $dispatching->id]) }}' enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row justify-content-center">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label text-center">No Transaksi</label>
                                        <input type="text" name="no_transaksi" value="{{ $dispatching->no_transaksi }}"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="date" name="tanggal" class="form-control border border-2 p-2" value="{{ $dispatching->tanggal }}">
                                    </div>
                                    <div class="mb-3 col-md-6">
