<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Input Dispatching" beforePage="Dispatchings"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                <div class="col-md-8 d-flex align-items-center">
                                    <h6 class="mb-3">Input Daftar Barang Keluar</h6>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-3">
                            <form method='POST' action='{{ route('input.dispatching') }}' enctype="multipart/form-data">
                                @csrf
