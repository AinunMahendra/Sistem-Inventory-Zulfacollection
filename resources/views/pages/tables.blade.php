                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div
                                ...
                                <h6 class="text-white text-capitalize ps-3">Tabel Master Barang</h6>
                            ...
                            <div class="table-responsive p-1">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody id="itemTableBody">
                                        {{-- Looping Data --}}
                                        @php
                                            $perPage = $items->perPage(); // Jumlah item per halaman
                                            $currentPage = $items->currentPage(); // Halaman saat ini
                                            $startingNumber = ($currentPage - 1) * $perPage + 1; // Hitung nomor awal untuk halaman saat ini
                                        @endphp
                                        @foreach ($items as $item)
                                            <tr>
                                                <td class="align-middle text-center text-sm">
                                                    <h6 class="mb-0 text-sm">{{ $startingNumber + $loop->index }}</h6>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                ...
                                <form role="form text-left" id="dataForm" action="barang" method="POST"
                                    ...
                                    <div class="input-group input-group-static my-2">
                                        ...
                                        <input type="hidden" name="stok" id="stok" class="form-control"
                                            onfocus="focused(this)" onfocusout="defocused(this)" required value="10">
                                    </div>
                                    <div class="input-group input-group-static my-2">
        ...
        <script type="text/javascript">
            $(function() {
                $(document).on('click', '.archive', function(e) {
                    ...
                    var actionUrl = '{{ url('barang') }}/' + itemId;
